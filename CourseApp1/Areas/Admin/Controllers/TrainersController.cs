...
namespace CourseApp1.Areas.Admin.Controllers
{
    ...
    public class TrainersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Name,Email,Description,Website,Creation_date")] Trainer trainer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Name,Email,Description,Website,Creation_date")] Trainer trainer)
        {
            if (ModelState.IsValid)
            {
