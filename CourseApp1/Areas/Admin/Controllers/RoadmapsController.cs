...
namespace CourseApp1.Areas.Admin.Controllers
{
    public class RoadmapsController : Controller
    {
        ...
        // GET: Admin/Roadmaps/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: Admin/Roadmaps/Create
